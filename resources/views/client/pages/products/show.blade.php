                ...
                <div class="content-bar">
                    <div class="single-page">
                        <div class="product-head">
                            <a href="{{ route('layouts') }}">Home</a> <span>::</span>
                        </div>
                        {{-- <link rel="stylesheet" href="{{ asset('client/css/etalage.css') }}"> --}}
                        {{-- <script src="{{ asset('client/js/jquery.etalage.min.js') }}"></script> --}}
                        <script>
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            ...
                                            <img class="etalage_source_image" src="images/m1.jpg" class="img-responsive"
                                                title="" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/m2.jpg" class="img-responsive" />
                                        <img class="etalage_source_image" src="images/m2.jpg" class="img-responsive"
                                            title="" />
                                    </li>
                                    <li>
                        ...
                        <div class="details-left-info">
                            ...
                            <p class="desc">The first mechanically-propelled, two-wheeled vehicle may have been built by
                                Kirkpatrick MacMillan, a Scottish blacksmith, in 1839, although the claim is often disputed.
                                He is also associated with the first recorded instance of a cycling traffic offense, when a
                                Glasgow newspaper in 1842 reported an accident in which an anonymous "gentleman from
                                Dumfries-shire... bestride a velocipede... of ingenious design" knocked over a little girl
                                in Glasgow and was fined five
                    ...
                    <div class="product-desc">
                        ...
                        <div class="prod1-desc">
                            ...
                            <p class="product_descr"> Vivamus ante lorem, eleifend nec interdum non, ullamcorper et arcu.
                                ...
                                himenaeos.eleifend nec interdum non, ullamcorper et arcu. Class aptent taciti sociosqu ad
