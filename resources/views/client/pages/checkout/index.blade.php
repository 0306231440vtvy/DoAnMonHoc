...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        @enderror
        <div class="space-y-3">
            <label class="flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-indigo-600">
            ...
            <div class="space-y-3 mb-6">
                @if ($checkout['totalDiscount'] > 0)
                    <div class="flex justify-between" style="margin-top:5px">
                        ...
                        <span
                            class="font-semibold text-red-600"><i>{{ number_format($checkout['totalDiscount']) }}</i></span>
                    </div>
                @endif
