    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <form action="{{ route('blog') }}" method="GET" class="d-flex">
            <input type="text" name="keyword" class="form-control me-2" 
                   placeholder="Tìm kiếm bài viết..." value="{{ request()->keyword }}">
        ...
        @if($posts->count() > 0)
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <img src="{{ $post->image ?? 'https://via.placeholder.com/350x200' }}" class="card-img-top" alt="{{ $post->title }}">
                    <div class="card-body">
                        <h5 class="card-title">
                    ...
                    <div class="card-footer bg-white border-0">
                        <a href="{{ route('blog.detail', $post->id) }}" class="btn btn-sm btn-outline-primary">Xem chi tiết</a>
