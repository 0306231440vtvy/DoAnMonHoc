        ...
        <div class="col-md-6">
            ...
            <div class="product-info">
                ...
                <p id="display-stock-info" class="text-muted">
                    Hiện tại còn <span id="display-stock-count" class="fw-bold">{{ $product->variants->sum('soluong') }}</span> sản phẩm.
                </p>
                ...
                <div class="product-variants mt-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        @foreach($product->variants->unique(function ($item) {
                            ...
                            <button type="button" 
                                    class="btn btn-outline-dark variant-select" 
...
<style>
    ...
    .main-image { width: 100%; height: 600px; object-fit: cover; }
    .img-thumbnail:hover { border-color: #000; }
</style>
