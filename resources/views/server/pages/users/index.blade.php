            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        {{-- Nút Thêm mới --}}
                        <a href="{{ route('server.users.create') }}" class="btn btn-primary btn-xs">
                                ...
                                @if(isset($users) && $users->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{-- Nút Sửa --}}
                                            <a href="{{ route('server.users.edit', $user->id) }}" class="btn btn-success btn-xs">
                                            ...
                                            @if($user->publish == 1)
                                                ...
                                                <a href="{{ route('server.users.destroy', $user->id) }}" 
                                            ...
                                            @else
                                                ...
                                                <a href="{{ route('server.users.restore', $user->id) }}" 
