        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{{ route('server.orders.index') }}" method="GET" class="form-horizontal">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label" style="text-align: left;">Từ khóa:</label>
                                    <input type="text" name="keyword" class="form-control" 
                                           placeholder="Nhập Mã đơn, Tên, SĐT..." 
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                ...
                                <a href="{{ route('server.orders.index') }}" class="btn btn-default">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($order->payment_status == 1)
                                                <small class="text-success font-bold"><i class="fa fa-check"></i> Đã TT</small>
                                            @else
                                                <small class="text-warning font-bold"><i class="fa fa-clock-o"></i> Chưa TT</small>
                                            @endif
                                        </td>

                                        <td>
                                            <i class="fa fa-calendar"></i> {{ \Carbon\Carbon::parse($order->created_at)->format('d/m/Y') }}<br>
                                            <i class="fa fa-clock-o"></i> {{ \Carbon\Carbon::parse($order->created_at)->format('H:i') }}
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('server.orders.show', $order->id) }}" class="btn btn-white btn-sm" title="Xem chi tiết">
